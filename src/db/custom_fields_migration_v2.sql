-- ============================================================================
-- Custom Fields Per Company Migration - V2
-- This version handles existing columns in customers table
-- ============================================================================
...
-- Insert ONLY the 3 essential system fields for all companies
-- These are the only fields that should be mandatory and visible to all companies
...
SELECT 
    ...
    COUNT(*) as total_system_fields_added
